...
- **Diseño / prototipo (alta fidelidad) — Tareas (panel principal):** [Figma — Tareas](https://www.figma.com/design/K6uQLWg82KsCSpHJVXSf6L/Sin-t%C3%ADtulo?node-id=1-1374)
- **Diseño / prototipo (alta fidelidad) — Modal Nueva Tarea:** [Figma — Tareas / Diálogo Nueva Tarea](https://www.figma.com/design/K6uQLWg82KsCSpHJVXSf6L/Sin-t%C3%ADtulo?node-id=1-1539)
